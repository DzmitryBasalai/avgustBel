...
!function () {
    ...
    var a = {
        ...
        enterLikeTab: !0,
        showApplyButton: !1
    }, r = null, n = "ru", o = "ru", i = {meridiem: ["AM", "PM"]}, s = function () {
        var t = a.i18n[o], n = {
            days: t.dayOfWeek,
        ...
        return s = function (a) {
            ...
            C.id && J.attr("id", C.id), C.style && J.attr("style", C.style), C.weeks && J.addClass("xdsoft_showweeks"), C.rtl && J.addClass("xdsoft_rtl"), J.addClass("xdsoft_" + C.theme), J.addClass(C.className), N.find(".xdsoft_month span").after(G), N.find(".xdsoft_year span").after(U), N.find(".xdsoft_month,.xdsoft_year").on("touchstart mousedown.xdsoft", function (t) {
                ...
                clearTimeout(u), u = setTimeout(function () {
                    ...
                    for (var t, i, s, d, u, l, f, c, m, h, g = "",
                             p = new Date(j.currentTime.getFullYear(), j.currentTime.getMonth(), 1, 12, 0, 0), y = 0,
                             v = j.now(), b = !1, D = !1, k = [], x = !0, T = "",
                             S = ""; p.getDay() !== C.dayOfWeekStart;)p.setDate(p.getDate() - 1);
